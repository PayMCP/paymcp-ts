...
describe('StripeProvider', () => {
  ...
  describe('createPayment', () => {
    it('should throw error when session response is missing id', async () => {
      ...
      ).rejects.toThrow('Invalid response from /checkout/sessions (missing id/url)');
    });
    ...
    it('should handle API errors', async () => {
      ...
      await expect(
        provider.createPayment(10.00, 'USD', 'Test payment')
  ...
  describe('getPaymentStatus', () => {
    ...
    it('should handle API errors', async () => {
      ...
      await expect(
        provider.getPaymentStatus('cs_test_123')
