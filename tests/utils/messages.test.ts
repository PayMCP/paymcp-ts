...
describe("Messages Utils", () => {
  describe("appendPriceToDescription", () => {
    ...
    it("should handle undefined description", () => {
      const price: PriceConfig = { amount: 5.0, currency: "EUR" };
  ...
  describe("paymentPromptMessage", () => {
    it("should format payment prompt message", () => {
      const result = paymentPromptMessage(
        "https://pay.example.com",
        10.99,
        "USD",
      );
      expect(result).toBe(
        "To continue, please pay 10.99 USD at:\nhttps://pay.example.com",
      );
    });
    ...
    it("should handle different currencies", () => {
      ...
      expect(result).toBe(
        "To continue, please pay 50 EUR at:\nhttps://pay.example.com",
      );
    });
    ...
    it("should handle zero amount", () => {
      ...
      expect(result).toBe(
        "To continue, please pay 0 USD at:\nhttps://pay.example.com",
      );
    });
    ...
    it("should handle large amounts", () => {
      ...
      expect(result).toBe(
        "To continue, please pay 999999.99 USD at:\nhttps://pay.example.com",
      );
    });

    it("should handle long URLs", () => {
      const longUrl =
        "https://very-long-payment-gateway.example.com/checkout/session/abc123def456/pay?ref=xyz";
