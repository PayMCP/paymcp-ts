...
export const buildX402middleware = (providers: ProviderInstances, stateStore: StateStore, paidtools: Record<string, { amount: number, currency: string, description?: string }>, clientInfo: ClientInfo, logger:Logger) => {
