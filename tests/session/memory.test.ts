...
describe('InMemorySessionStorage', () => {
  ...
  describe('set and get', () => {
    ...
    it('should handle different providers with same payment ID', async () => {
      const stripeKey: SessionKey = { provider: 'stripe', paymentId: 'pay_123' };
      const paypalKey: SessionKey = { provider: 'paypal', paymentId: 'pay_123' };
  ...
  describe('cleanup', () => {
    ...
    it('should remove expired sessions but keep valid ones', async () => {
      const expiredKey: SessionKey = { provider: 'stripe', paymentId: 'expired' };
      const validKey: SessionKey = { provider: 'stripe', paymentId: 'valid' };
      const permanentKey: SessionKey = { provider: 'stripe', paymentId: 'permanent' };
