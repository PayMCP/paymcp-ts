...
describe('WalleotProvider', () => {
  ...
  describe('createPayment', () => {
    ...
    it('should handle different currencies', async () => {
      ...
      await provider.createPayment(25.50, 'EUR', 'EUR payment');
    ...
    it('should handle missing sessionId in response', async () => {
      ...
      ).rejects.toThrow('Invalid response from /sessions (missing sessionId/url)');
    });
  ...
  describe('getPaymentStatus', () => {
    ...
    it('should handle API errors', async () => {
      ...
      await expect(
        provider.getPaymentStatus('ws_invalid')
    ...
    it('should handle network errors', async () => {
      ...
      await expect(
        provider.getPaymentStatus('ws_test123')
      ).rejects.toThrow('Network error');
    });
  });
