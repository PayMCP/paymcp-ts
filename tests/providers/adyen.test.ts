...
describe('AdyenProvider', () => {
  ...
  describe('createPayment', () => {
    it('should create payment session successfully', async () => {
      ...
      expect(result).toEqual({
        ...
        paymentUrl: 'https://checkoutshopper-test.adyen.com/checkoutshopper/demo/adyen-checkout/v1/session.shtml?sessionId=CS1234567890',
      });
  ...
  describe('getPaymentStatus', () => {
    ...
    it('should handle API errors', async () => {
      ...
      await expect(
        provider.getPaymentStatus('CS1234567890')
