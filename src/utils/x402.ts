 ...
 */
export function withDefaultUrl(resource: any, toolName: string): Record<string, any> {
    const base = resource && typeof resource === "object" && !Array.isArray(resource) ? { ...resource } : {};
